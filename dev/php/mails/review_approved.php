<?
	...
	$mailContent .= "Which means you get a hard cold extra vote to use on the app list page!!!<br/><br/>";

	$mailContent .= "Congratulations and thanks a lot for your review,<br/>";
	$mailContent .= "it's people like you that make Android Liftoff a great place to be,<br/>";
	$mailContent .= "and to help each other out!!!<br/><br/>";
